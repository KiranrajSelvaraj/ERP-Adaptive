...
public class BCRSCreditNoteTest extends BaseClass{
			...
			if (IsEnableBCRS == true) {
			    ...
			    for (int j = 0; j < ProductDetailsList.size(); j++) {
			        ...
			        if (product.productName.equalsIgnoreCase(excelData.ProductName)
			            ...
			            String bcrsQty = driver.findElement(By.xpath("(//table[@id='CreditNoteTable']//tbody//tr//td//textarea[text()='Z Delivery Charges']//following::td//input[@class='form-control QtyTextBox'])[2]"))
			            		.getAttribute("value");
			            ...
			            String bcrsAmount = driver.findElement(By.xpath("//table[@id='CreditNoteTable']//tbody//tr//td//textarea[text()='Z Delivery Charges']//following::td[@id='totaldetailamount']"))
			            		.getText();
