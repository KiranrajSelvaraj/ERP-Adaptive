...
public class DemoSiteCreditNoteTest  extends BaseClass {
	...
	public Object[][] Util1() {
		...
		Object data[][] = Util1.getTestData("C:\\Adaptive\\Automation\\Bizapp\\DemoSalesExcel1.xlsx", "Sheet1");
		return data;
	...
	public void DirecteCreditNote() throws InterruptedException, IOException {
		...
		for (int i = 0; i < excelDataListSize; i++) {
			...
			click(cn.Qty);
			Thread.sleep(1000);
			driver.findElement(By.id("RatingType")).click();
