...
public class CustomerPaymentTest extends BaseClass {
	...
	public Object[][] Util1() {
		...
		Object data[][] = Util1.getTestData("C:\\Adaptive\\Automation\\Bizapp\\DirectSalesInvoice.xlsx", "Sheet1");
		return data;
	...
	public void Customer() throws InterruptedException {
		...
		for (int i = 0; i < excelDataListSize; i++) {
			...
			if (i == 0) {
				...
				click(cs.SearchField);
				Sendkeys(cs.SearchField, excelData.Customer);

				Thread.sleep(2000);
				click(cs.Fetch);					
				Thread.sleep(2000);
				WebElement details = driver.findElement(By.xpath
						("//table[@id='customertable']//tbody//tr//td//a[@title='Details']"));
				details.click();

				String customeName = driver.findElement(By.xpath("//h2//child::b")).getText();
				System.out.println("Customer Name: "+customeName);

				String currency = driver.findElement(By.xpath
						("(//dt[normalize-space()='Currency']//following-sibling::dd)[1]")).getText();
				System.out.println("Currency: "+currency);

				String totalIncome = driver.findElement(By.xpath
						("//div//span[text()=' Total Income']//following-sibling::b")).getText();
				System.out.println("Total Income: "+totalIncome);

				String due = driver.findElement(By.xpath
						("//span[text()=' Due']//following-sibling::b[@id='dueAmt']")).getText();
				System.out.println("Due: "+due);

				String arAccount = driver.findElement(By.xpath
						("//dt[normalize-space()='A/R Account']//following-sibling::dd")).getText();
				System.out.println("A/R Account: "+arAccount);

				WebElement infoTab = driver.findElement(By.xpath("//a[text()='Info']"));
				infoTab.click();

				String creditLimit = driver.findElement(By.xpath
						("//dt[text()='Credit Limit']//following-sibling::dd[@id='dcreditLimt']")).getText();
				System.out.println("Credit Limit: "+creditLimit);

				String creditOnHold = driver.findElement(By.xpath
						("//dt[text()='Credit On Hold']//following-sibling::dd[@id='dcreditonHold']")).getText();
				System.out.println("Credit On Hold: "+creditOnHold);

				String gst = driver.findElement(By.xpath
						("(//dt[text()='GST']//following-sibling::dd)[1]")).getText();
				System.out.println("Gst: "+gst);

				String gstType = driver.findElement(By.xpath
						("(//dt[text()='GST Type']//following-sibling::dd)[1]")).getText();
	...
	public void SalesInvoice() throws InterruptedException, IOException {
		...
		// Over All Discount:-
		Thread.sleep(2000);
		click(si.OverAllDiscountType);
		Select overAllDiscTypeSelect = new Select(si.OverAllDiscountType);
		...
		Thread.sleep(1000);
		click(si.OverAllDiscount);
		if (getOverAllDiscountType.equals("$")) {
			si.OverAllDiscount.sendKeys(Keys.CONTROL + "a" + Keys.DELETE);
			Sendkeys(si.OverAllDiscount, getExcelOverAllDiscountAmount + Keys.ENTER);
			click(si.OverAllDiscount);

		} else if (getOverAllDiscountType.equals("%")) {
			si.OverAllDiscount.sendKeys(Keys.CONTROL + "a" + Keys.DELETE);
			Sendkeys(si.OverAllDiscount, getExcelOverAllDiscountPercentage + Keys.ENTER);
			click(si.OverAllDiscount);
		...
		String currencyName = si.CurrencyCode.getText().trim();
		...
		Thread.sleep(3000);
		js.executeScript("arguments[0].click();", si.Post);
		...
		int postTable = driver.findElements(By.xpath("//table[@id='post']//tbody//tr")).size();
		System.out.println("Post Table: "+postTable);

		for (int i = 1; i < postTable; i++) {

			Thread.sleep(1000);
			String invoiceNo = driver.findElement(By.xpath("//table[@id='post']//tbody//tr["+i+"]//td[1]")).getText();
			String trimInvoiceNo = invoiceNo.replaceAll("\\Sales", "").trim();
			invoiceNumber = trimInvoiceNo.replaceAll("[()]", "").trim();
			System.out.println("Invoice No: "+invoiceNumber);

			String customerName = driver.findElement(By.xpath("//table[@id='post']//tbody//tr["+i+"]//td[2]")).getText();
			System.out.println("Customer Name: "+customerName);

			String accountDescription = driver.findElement(By.xpath("//table[@id='post']//tbody//tr["+i+"]//td[3]")).getText();
			System.out.println("Account Description: "+accountDescription);

			String debits = driver.findElement(By.xpath("//table[@id='post']//tbody//tr["+i+"]//td[4]")).getText();
			System.out.println("Debit: "+debits);

			String credits = driver.findElement(By.xpath("//table[@id='post']//tbody//tr["+i+"]//td[5]")).getText();
			System.out.println("Credits: "+credits);
			System.out.println();

		}

		String debitTotal = driver.findElement(By.id("debitTotal")).getText();
		System.out.println("Debit Total: "+debitTotal);

		String creditTotal = driver.findElement(By.id("creditTotal")).getText();
		System.out.println("Credit Total: "+creditTotal);
		System.out.println();

		WebElement post = driver.findElement(By.xpath("//div[@id='PartialPopup']//child::input[@value='Post']"));
		post.click();


		String invoiceStatus = driver.findElement(By.xpath
				("//table[@id='Invoicetable']//tbody//tr//td[text()='"+invoiceNumber+"']//following-sibling::td[@class='getstatus']//span")).getText();
		System.out.println("Invoice Status: "+invoiceStatus);
		System.out.println();
		System.out.println("** Sales Invoice Post Successfull **");
		System.out.println();

	}

	@Test(priority = 16, dependsOnMethods = "SalesInvoice")
	public void CustomerPayment() {

		driver.navigate().to(url +"SalesPurchases/CustomerPayments/IndexBuilder_CP");
		driver.manage().timeouts().pageLoadTimeout(200, TimeUnit.SECONDS);
		driver.manage().timeouts().implicitlyWait(60, TimeUnit.SECONDS);
		CustomerPayment cp = new CustomerPayment(driver);
		...
		for (int i = 0; i < excelDataListSize; i++) {
			...
			click(cp.Customer);
			WebElement customerSearch = driver.findElement(By.xpath
					("//span[@id='select2-CustomerId-container']//following::input[@type='search']"));
			customerSearch.sendKeys(excelData.Customer +Keys.ENTER);
			try {
				...
				System.out.println("No Alert Appear in Customer Payment");
			}
			break;
		}

		int customerPaymentTableSize = driver.findElements(By.xpath
				("//table[@id='customerpaymenttable']//tbody//tr")).size();
		System.out.println("Customer Payment Table Size: "+customerPaymentTableSize);

		if (customerPaymentTableSize > 1) {

			WebElement checkBox = driver.findElement(By.xpath
					("//table[@id='customerpaymenttable']//tbody//tr//td[contains(normalize-space(),'"+invoiceNumber+"')]//preceding-sibling::td//input[@id='check']"));
			checkBox.click();
		} else {

			System.out.println("No customer payment data in the table");
		}

		String amount = driver.findElement(By.xpath
				("//table[@id='customerpaymenttable']//tbody//tr//td[contains(normalize-space(),'"+invoiceNumber+"')]//ancestor::tr//td[4]"))
				.getText();
		System.out.println("Amount: "+amount);

		String opening = driver.findElement(By.xpath
				("//table[@id='customerpaymenttable']//tbody//tr//td[contains(normalize-space(),'"+invoiceNumber+"')]//ancestor::tr//td[@id='FCOpnBal']"))
				.getText();
		System.out.println("Opening: "+opening);

		String payment = driver.findElement(By.xpath
				("//table[@id='customerpaymenttable']//tbody//tr//td[contains(normalize-space(),'"+invoiceNumber+"')]//ancestor::tr//td[@class='tdpayment']//input[@id='Payment']"))
				.getAttribute("value");
		System.out.println("Payment: "+payment);

		String balance = driver.findElement(By.xpath
				("//table[@id='customerpaymenttable']//tbody//tr//td[contains(normalize-space(),'"+invoiceNumber+"')]//ancestor::tr//td[@class='tdbalance']//label[@id='FCBalanceAmount']"))
				.getText();
		System.out.println("Balance: "+balance);

		String totalAmountToPay = driver.findElement(By.xpath
				("//table[@id='customerpaymenttable']//tbody//tr//td[@class='commaseperator tdpayment']"))
				.getText();
		System.out.println("Total Amount To Pay: "+totalAmountToPay);

		String amountReceived = driver.findElement(By.xpath("//input[@id='AmountRecieved']"))
				.getAttribute("value");
		System.out.println("Amount Received:" +amountReceived);

		soft.assertEquals(totalAmountToPay, amountReceived, "TotalAmountToPay and AmountReceived Paid Mismatched");
		...
		try {
			...
			System.out.println("No Alert Appear in Save");
		}
		click(cp.PopupOk);
		System.out.println();
	...
	@Test(priority = 18, dependsOnMethods = "CustomerPayment")
	...
	@Test(priority = 20, dependsOnMethods = "VerifyCustomer")
	public void MultipleInvoiceCustomerPayment() throws InterruptedException {
		
		driver.navigate().to(url +"SalesPurchases/CustomerPayments/IndexBuilder_CP");
		driver.manage().timeouts().pageLoadTimeout(200, TimeUnit.SECONDS);
		driver.manage().timeouts().implicitlyWait(60, TimeUnit.SECONDS);
		CustomerPayment cp = new CustomerPayment(driver);
		System.out.println("** Customer Payment for Multiple Invoice **");
		...
		for (int i = 0; i < excelDataListSize; i++) {
			...
			click(cp.CheckBoxAll);
			break;
		}
		double PositivePayment = 0;
		double NegativePayment = 0;
		
		Thread.sleep(2000);
		int customerPaymentTableSize = driver.findElements(By.xpath
				("//table[@id='customerpaymenttable']//tbody//tr")).size();
		System.out.println("Customer Payment Table Size: "+customerPaymentTableSize);
		for (int j = 1; j < customerPaymentTableSize; j++) {
			
			String amount = driver.findElement(By.xpath
					("(//table[@id='customerpaymenttable']//tbody//tr//td[@id='FCOpnBal']//preceding-sibling::td[1])["+j+"]"))
					.getText();
			System.out.println("Amount: "+amount);

			String opening = driver.findElement(By.xpath
					("(//table[@id='customerpaymenttable']//tbody//tr//td[@id='FCOpnBal'])["+j+"]"))
					.getText();
			System.out.println("Opening: "+opening);

			String payment = driver.findElement(By.xpath
					("(//table[@id='customerpaymenttable']//tbody//tr//td//input[@id='Payment'])["+j+"]"))
					.getAttribute("value").trim();
	
			String replacePayment = payment.replaceAll(",", "");
			double doublePayment = Double.parseDouble(replacePayment);
			
			if (doublePayment < 0) {
				
				System.out.println("Payment: "+doublePayment);
				NegativePayment += doublePayment;
				
			} else {
				
				System.out.println("Payment: "+doublePayment);
				PositivePayment += doublePayment;
			}
			

			String balance = driver.findElement(By.xpath
					("(//table[@id='customerpaymenttable']//tbody//tr//td//label[@id='FCBalanceAmount'])["+j+"]"))
					.getText();
			System.out.println("Balance: "+balance);
			System.out.println();
		}
		
		System.out.println("Positive Payment: "+PositivePayment);
		System.out.println("Negative Payment: "+NegativePayment);
		System.out.println();
		
		String totalAmountToPay = driver.findElement(By.xpath
				("//table[@id='customerpaymenttable']//tbody//tr//td[@id='amounttopay']")).getText();
		System.out.println("Actual Total Amount To Pay: "+totalAmountToPay);
		
		double expPayment = PositivePayment - NegativePayment;
		System.out.println("Expected Total Amount To Pay: "+expPayment);
		System.out.println();
		
		String actualAmountreceived = driver.findElement(By.id("AmountRecieved")).getAttribute("value");
		System.out.println("Actual Amount Received: "+actualAmountreceived);
		System.out.println("Expected Amount Received: "+expPayment);
		System.out.println();
		...
		System.out.println("** Multiple Invoice Costomer Payment save **");
