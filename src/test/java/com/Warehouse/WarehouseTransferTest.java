...
import com.PomClass.WarehouseTransfer;
import com.Utility.Util1;

import io.github.bonigarcia.wdm.WebDriverManager;

public class WarehouseTransferTest extends BaseClass{
	...
	public Object[][] Util1() {
		...
		Object data[][] = Util1.getTestData("C:\\Adaptive\\Automation\\Bizapp\\WarehouseTransfer.xlsx", "Sheet1");
		return data;
	...
	class ExcelData {
		...
		public ExcelData(String FromWarehouse, String ToWarehouse, String ProductCode, String ProductName, String Uom, 
				String Qty, String BatchProduct, String BatchNumber, String MfgDate, String ValidPeriod, String ExpDate) {
			super();
	...
	public void GetData(String FromWarehouse, String ToWarehouse, String ProductCode, String ProductName, String Uom, 
			String Qty, String BatchProduct, String BatchNumber, String MfgDate, String ValidPeriod, String ExpDate) {

		ExcelData data = new ExcelData(FromWarehouse, ToWarehouse, ProductCode, ProductName, Uom, Qty, BatchProduct,
				BatchNumber, MfgDate, ValidPeriod, ExpDate);
	...
	public void WarehouseTransfer() throws InterruptedException {
		...
		for (int i = 0; i < excelDataListSize; i++) {
			...
			if (i == 0) {
				...
				click(wt.CreateFromWarehouse);
				WebElement fromWarehouseSearch = driver.findElement(By.xpath
						("//span[@id='select2-FromWarehouseId-container']//following::input[@type='search']"));
				fromWarehouseSearch.sendKeys(excelData.FromWarehouse +Keys.ENTER);

				Thread.sleep(2000);
				click(wt.createToWarehouse);
				WebElement toWarehouseSearch = driver.findElement(By.xpath
						("//span[@id='select2-ToWarehouseId-container']//following::input[@type='search']"));
				toWarehouseSearch.sendKeys(excelData.ToWarehouse +Keys.ENTER);				

			}
			Thread.sleep(2000);
			click(wt.Qty);
			Actions action = new Actions(driver);
			action.click(wt.Product).perform();
			//	click(wt.Product);
			WebElement productSearch = driver.findElement(By.xpath
			...
			if (excelData.BatchProduct.equalsIgnoreCase("true")) {
				...
				String bQty = driver.findElement(By.xpath
						("//strong[contains(text(),'"+excelData.ProductName.trim()+"')]//following::div[text()='B.Qty : ']//child::strong//input[@id='BQty']"))
						.getAttribute("value");
				System.out.println("bQty: "+bQty);

				String lQty = driver.findElement(By.xpath
						("//strong[contains(text(),'"+excelData.ProductName.trim()+"')]//following::div[text()='B.Qty : ']//child::strong//input[@id='LQty']"))
						.getAttribute("value");
				System.out.println("lQty: "+lQty);

				WebElement fromBulkQty = driver.findElement(By.id("BulkQty"));
				boolean fromisReadOnly = fromBulkQty.getAttribute("readonly") != null;
				boolean fromisEnabled = fromBulkQty.isEnabled();

				if (!fromisReadOnly && fromisEnabled) {
					Thread.sleep(2000);
					WebElement fromBulkQtyField = driver.findElement(By.xpath
							("(//strong[contains(text(),'"+excelData.ProductName.trim()+"')]//following::b[text()='From Product Batch']//following::table)[1]//child::td[6]//input[@id='BulkQty']"));
					fromBulkQtyField.click();
					fromBulkQtyField.sendKeys(Keys.CONTROL +"a"+ Keys.DELETE);
					fromBulkQtyField.sendKeys(bQty);
				...
				Thread.sleep(2000);
				WebElement fromLooseQtyField = driver.findElement(By.xpath
						("(//strong[contains(text(),'"+excelData.ProductName.trim()+"')]//following::b[text()='From Product Batch']//following::table)[1]//child::td[7]//input[@id='LooseQty']"));
				fromLooseQtyField.click();
				fromLooseQtyField.sendKeys(Keys.CONTROL +"a"+ Keys.DELETE);
				fromLooseQtyField.sendKeys(lQty);
				Thread.sleep(2000);

				// To warehouse batch details
				WebElement batchNumberField = driver.findElement(By.xpath
						("//strong[contains(text(),'"+excelData.ProductName.trim()+"')]//following::b[text()='To Product Batch']//following::table//tbody//tr//td[1]//input[@id='BatchNumber']"));
				batchNumberField.click();
				batchNumberField.sendKeys(excelData.BatchNumber);
				Thread.sleep(1000);

				WebElement mfgDateField = driver.findElement(By.xpath
						("//strong[contains(text(),'"+excelData.ProductName.trim()+"')]//following::b[text()='To Product Batch']//following::table//tbody//tr//td[3]//input[@class='form-control ManufactureDate datepick hasDatepicker']"));
				mfgDateField.click();
				//	mfgDateField.sendKeys(excelData.MfgDate +Keys.ENTER);	
				Thread.sleep(1000);
				WebElement datePicker = driver.findElement(By.xpath
						("//div[@id='ui-datepicker-div']//following-sibling::table//tbody//tr//td//a[contains(text(),'"+excelData.MfgDate.trim()+"')]"));
				datePicker.click();
				Thread.sleep(1000);

				WebElement validPeriodField = driver.findElement(By.xpath
						("//strong[contains(text(),'"+excelData.ProductName.trim()+"')]//following::b[text()='To Product Batch']//following::table//tbody//tr//td[4]//input[@id='ValidPeriod']"));
				validPeriodField.click();
				validPeriodField.sendKeys(Keys.CONTROL +"a"+ Keys.DELETE);
				validPeriodField.sendKeys(excelData.ValidPeriod);

				/*	WebElement expDateField = driver.findElement(By.xpath
						("//strong[contains(text(),'"+excelData.ProductName.trim()+"')]//following::b[text()='To Product Batch']//following::table//tbody//tr//td[5]//input[@class='form-control ExpiryDate datepick hasDatepicker']"));
				expDateField.click();
				expDateField.sendKeys(excelData.ExpDate); */

				WebElement toBulkQty = driver.findElement(By.id("BulkQty"));
				boolean toisReadOnly = toBulkQty.getAttribute("readonly") != null;
				boolean toisEnabled = toBulkQty.isEnabled();

				if (!toisReadOnly && toisEnabled) {
					Thread.sleep(2000);
					WebElement toBulkQtyField = driver.findElement(By.xpath
							("(//strong[contains(text(),'"+excelData.ProductName.trim()+"')]//following::b[text()='To Product Batch']//following::table)[1]//child::td[6]//input[@id='BulkQty']"));
					toBulkQtyField.click();
					toBulkQtyField.sendKeys(Keys.CONTROL +"a"+ Keys.DELETE);
					toBulkQtyField.sendKeys(bQty);
					System.out.println("Editable field");
				} else {
					System.out.println("Readonly field");
				}
				Thread.sleep(2000);
				WebElement toLooseQtyField = driver.findElement(By.xpath
						("(//strong[contains(text(),'"+excelData.ProductName.trim()+"')]//following::b[text()='To Product Batch']//following::table)[1]//child::td[7]//input[@id='LooseQty']"));
				toLooseQtyField.click();
				toLooseQtyField.sendKeys(Keys.CONTROL +"a"+ Keys.DELETE);
				toLooseQtyField.sendKeys(lQty);
				Thread.sleep(2000);

				WebElement batchAddBtn = driver.findElement(By.xpath
						("//strong[contains(text(),'"+excelData.ProductName.trim()+"')]//following::div[@class='modal-footer']//child::button[@class='btn btn-default' and text()='Add']"));
				batchAddBtn.click();
		...
		System.out.println("*** Warehouse Transfer Save Successfull ***"); 
		System.out.println();
				...
				if (productData.productName.equalsIgnoreCase(excelData.ProductName)) {
					...
					if (productData.IsCarton) {
						...
						for (String currentStock : splitCurrentStockValue) {
							...
							System.out.println("calculateStockDouble: "+calculateStockDouble);
