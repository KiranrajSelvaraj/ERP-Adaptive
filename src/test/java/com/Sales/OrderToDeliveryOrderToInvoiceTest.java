...
public class OrderToDeliveryOrderToInvoiceTest extends BaseClass {
	...
	public Object[][] Util1() {
		...
		Object data[][] = Util1.getTestData("C:\\Adaptive\\Automation\\Bizapp\\OrderToDeliveryOrderToInvoice.xlsx", "Sheet1");
		return data;
	...
	public void ProductPage() throws InterruptedException {
		...
		for (String product : ProductSet) {
			...
			WebElement DetailsIcon = driver
					.findElement(By.xpath("//table[@id='producttable']//tbody//tr//td[normalize-space()='" + product
	...
	public void SalesToInvoice() throws InterruptedException, IOException {
		...
		for (int i = 0; i < excelDataListSize; i++) {
			...
			productPrice = driver
					.findElement(By.xpath("//table[@id='OrderTable']//tbody//tr//td//div//textarea[contains(text(),'"
							+ excelData.ProductName + "')]//following::td//p[@class='totaldetailamount']"))
					.getText();
		...
		try {
			...
			System.out.println("No alert appeared after Convert Delivery Order.");
		}	
		click(so.PopupOk);
		Thread.sleep(3000);
		...
		/*	WebElement edit = driver.findElement(By.xpath
				("(//table[@id='DeliveryOrderTable']//tbody//tr//td//a[@title='Edit'])[1]"));
		edit.click();*/
		Thread.sleep(3000);
