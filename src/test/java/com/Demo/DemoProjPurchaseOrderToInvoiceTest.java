...
public class DemoProjPurchaseOrderToInvoiceTest extends BaseClass {
	...
	@DataProvider
	public Object[][] Util1() {
		Object[][] data = Util1.getTestData("C:\\Adaptive\\Automation\\Bizapp\\DemoProjExcel2.xlsx", "Sheet1");
		return data;
	...
	class ExcelData {
		...
		public ExcelData(String Vendor, String ProjectName, String CurrencyCode, String CurrancyRate, String GstType, String Type,
				...
				String Price, String OverAllDiscountType, String OverAllDiscountAmount, String OverAllDiscountPercentage,
				String GstPercentage, String ZeroGst, String BatchProduct, String BatchNumber, String MfgDate, String ValPeriod, String ExpDate) {
	...
	public void GetData(String Vendor, String ProjectName, String CurrencyCode, String CurrancyRate, String GstType, String Type,
			String ProductCode, String ProductName, String Uom, String Qty, String Foc, String DiscountPercentage,
			String DiscountAmount, String UnitDiscCheckbox, String UnitDiscPercentage, String UnitDiscAmount,
			String Price, String OverAllDiscountType, String OverAllDiscountAmount, String OverAllDiscountPercentage,
			String GstPercentage, String ZeroGst, String BatchProduct, String BatchNumber, String MfgDate, String ValPeriod, String ExpDate) {

		ExcelData data = new ExcelData(Vendor, ProjectName, CurrencyCode, CurrancyRate, GstType, Type, ProductCode, ProductName,
				Uom, Qty, Foc, DiscountPercentage, DiscountAmount, UnitDiscCheckbox, UnitDiscPercentage, UnitDiscAmount,
				Price, OverAllDiscountType, OverAllDiscountAmount,
		...
		for (String vendor : VendorSet) {
			...
			if (vendor != null) {
				...
				WebElement details = driver.findElement(
						By.xpath("//table[@id='vendortable']//tbody//tr//td[normalize-space()='"+vendor+"']//following::td//a[@title='Details']"));
	...
	public void PurchaseOrderToInvoice() throws InterruptedException, IOException {
		...
		for (int i = 0; i < excelDataListSize; i++) {
			...
			if (excelData.Type.equalsIgnoreCase("Product")) {
				...
				inputsearch.click();
				inputsearch.sendKeys(excelData.ProductName +Keys.ENTER);
			...
			if (unitDiscCheckboxBoolean == true) {
				...
				double discPercentDouble = 0.0;
				double discAmtDouble1 = 0.0;

				if (excelData.DiscountPercentage != null && !excelData.DiscountPercentage.trim().isEmpty()) {

					discPercentDouble = Double.parseDouble(excelData.DiscountPercentage);
				...
				else if (excelData.DiscountAmount.isEmpty() == true) {

					try {

						discAmtDouble1 = Double.parseDouble(excelData.DiscountAmount);
			...
			if (CompanyCode.equalsIgnoreCase("amc")) {
				...
				String getTotalQty = driver.findElement(By.xpath("//input[@id='batchHead']"))						
						.getAttribute("value");
				System.out.println("totalQty: "+getTotalQty);

				driver.findElement(By.xpath("(//table[@class='table table-bordered Mytable']//tbody//tr//td)[1]")).click();
				driver.findElement(By.xpath("//input[@role='textbox']")).sendKeys(excelData.ProjectName +Keys.ENTER);

				WebElement totalQty = driver.findElement(By.xpath
						("//input[@class='form-control ProjectDetailQty']"));
				totalQty.sendKeys(Keys.CONTROL +"a"+ Keys.DELETE);
				totalQty.sendKeys(getTotalQty);
				...
				driver.findElement(By.xpath("//div[@class='modal-footer']//child::button[text()='Add']"))
				.click();
			...
			productPrice = driver.findElement(By.xpath("//table[@id='PurchaseOrderTable']//tbody//tr//td[@class='orderTotal']")).getText(); 
		...
		Thread.sleep(1000);
		click(po.InvoiceNo);
		Sendkeys(po.InvoiceNo, invoiceNo);
		Thread.sleep(3000);
