...
public class BCRSPurchaseInvoiceTest extends BaseClass {
	...
	public void PurchaseInvoice() throws InterruptedException {
		...
		String invoiceNo = "Inv"+formatedTimestamp;
	...
	//	String getExcelGstPercentage = "";
		...
		for (int i = 0; i < excelDataListSize; i++) {
			...
			if (excelData.Vendor.isEmpty() == false) {
				...
				gstType = driver.findElement(By.id("select2-GSTTypeId-container")).getText();
