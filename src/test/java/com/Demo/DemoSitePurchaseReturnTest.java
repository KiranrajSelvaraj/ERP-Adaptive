...
public class DemoSitePurchaseReturnTest extends BaseClass {
	...
	public void Environment(String env, String Company) {
		...
		if (env.equals("demo") && Company.equals("sdc")) {
			Environment = "demo";
			CompanyCode = "sdc";
			CompanyName = "sdc";
	...
	public void ProductPage() throws InterruptedException {
		...
		for (String product : ProductSet) {
			...
			if (!CompanyCode.equals("sdc")) {
				...
				marginToleranceValue = marginTolerance.getText();
