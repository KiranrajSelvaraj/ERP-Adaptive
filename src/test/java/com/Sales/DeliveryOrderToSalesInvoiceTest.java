...
import com.Sales.DirectDeliveryOrderTest.ExcelData;
import com.Sales.DirectDeliveryOrderTest.StockCalculation;
import com.Sales.DirectDeliveryOrderTest.UOM;
import com.Sales.DirectDeliveryOrderTest.product;
import com.Utility.Util1;

import io.github.bonigarcia.wdm.WebDriverManager;

public class DeliveryOrderToSalesInvoiceTest extends BaseClass {
	...
	public Object[][] Util1() {
		...
		Object data[][] = Util1.getTestData("C:\\Adaptive\\Automation\\Bizapp\\DeliveryOrderToInvoice.xlsx", "Sheet1");
		return data;
	...
	public void SalesToInvoice() throws InterruptedException, IOException {
		...
		double withoutZeroGstAmount = (discountTotalAmount - subrationZerGstAmount);
		System.out.println();
		...
		click(so.PopupOk);
		System.out.println("** Sales Order Save Successfull **");
		System.out.println();
		System.out.println("** Delivery Order Page **");
		click(dvo.Save);
		try {
