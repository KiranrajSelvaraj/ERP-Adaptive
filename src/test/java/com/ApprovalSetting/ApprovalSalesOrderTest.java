...
public class ApprovalSalesOrderTest extends BaseClass {
	...
	public void ApprovalSetting() {
		...
		for (int i = 0; i < approvalDataListSize; i++) {
			...
			if (i == 0) {
				...
				/*	driver.findElement(By.id("select2-otwi-container")).click();
				WebElement paymentsearch = driver.findElement(By.xpath
						("//span[@id='select2-otwi-container']//following::input[@type='search']"));
